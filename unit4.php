    ...
    <nav class="navbar navbar-expand-lg navbar-light">
        ...
        <div class="collapse navbar-collapse">
            <ul class="navbar-nav mr-auto">
                <li class="nav-item">
                    <a class="nav-link" href="show/view_data.php?unit=unit4&action=legal">Legal</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="show/view_data.php?unit=unit4&action=illegal">Illegal</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="show/view_data.php?unit=unit4&action=changing">Changing</a>
                </li>
            </ul>
    ...
    <div class="container">
        ...
        <div class="d-flex">
            <div class="search-form">
                <h2>Unit 4</h2>
                <form id="searchForm" action="unit4.php" method="get">
                ...
                <!-- Button to access all data for Unit 4 -->
                <a href="unit1_all_data.php?unit=unit4" class="btn btn-info mt-4">View All Data of Unit 4</a>
            </div>
            <div class="member-details">
                ...
                if (isset($_GET['cnic'])) {
                   ...
                   include 'db.php';
                    ...
                    $stmt = $conn->prepare("SELECT id, name, father_name, cnic, mobile_no, fees, address, computer_no, card_no, date_of_issue FROM unit4 WHERE cnic = ?");
                    ...
                    if ($stmt->num_rows > 0) {
                        ...
                        <div class='result-buttons'>
                            <form id='copyDataForm' action='copy_data.php' method='post'>
                                ...
                                <input type='hidden' name='unit' value='unit4'>
